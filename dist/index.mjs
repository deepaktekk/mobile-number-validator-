...
var countryData_default = [
  ...
  },
  {
    ...
    phoneNumberLengthByCountry_phLength_InternationalPrefix: 0,
    phoneNumberLengthByCountry_phLength_NationalPrefix: 0,
    phoneNumberLengthByCountry_Notes: "When dialling from Ireland to Northern Ireland, the area code used should be '048' instead of '0044 28'."
  },
  {
    country: "Mauritania",
  ...
  },
  {
    ...
    phoneNumberLengthByCountry_phLength_InternationalPrefix: 0,
    phoneNumberLengthByCountry_phLength_NationalPrefix: null,
    phoneNumberLengthByCountry_Notes: "Seven digits for the fixed network and eight digits for the mobile network."
  },
  {
    country: "Kuwait",
    phoneNumberLengthByCountry_phLengthMax: 8,
  ...
  },
  {
    ...
    phoneNumberLengthByCountry_phLength_InternationalPrefix: 0,
    phoneNumberLengthByCountry_phLength_NationalPrefix: null,
    phoneNumberLengthByCountry_Notes: "11 digits for voice-mail services only."
  },
  {
    country: "Eswatini",
    phoneNumberLengthByCountry_phLengthMax: 8,
  ...
  },
  {
    ...
    phoneNumberLengthByCountry_phLength_InternationalPrefix: 0,
    phoneNumberLengthByCountry_phLength_NationalPrefix: null,
    phoneNumberLengthByCountry_Notes: "The country code listed is for future use (Vatican is currently using country code '39')."
  }
];
